    ...
    build: {
        base: {
            src: {
                ...
                scripts: [
                    "{$config.path.common_src}/components/components/**/*.js",
                    "{$config.path.common_src}/components/layout/**/*.js",
                    "{$config.path.src}/components/layout/**/*.js"
                ]
            },
            dist: {
                styles: "{$config.dist}/css/style.bundle.css",
                scripts: "{$config.dist}/components/scripts.bundle.js",
            }
        },
        plugins: {
            global: {
                src: {
                    mandatory: {
                        ...
                        bootstrap: {
                            scripts: [
                                "{$config.path.node_modules}/bootstrap/dist/components/bootstrap.min.js",
                            ],
                        },
                        moment: {
                            scripts: [
                    ...
                    optional: {
                        ...
                        select2: {
                            ...
                            scripts: [
                                "{$config.path.node_modules}/select2/dist/components/select2.full.js",
                                "{$config.path.common_src}/components/vendors/plugins/select2.init.js",
                            ],
                        },
                        "tempus-dominus": {
                            styles: [
                            ...
                            scripts: [                                
                                "{$config.path.node_modules}/@eonasdan/tempus-dominus/dist/components/tempus-dominus.min.js",
                                "{$config.path.common_src}/components/vendors/plugins/tempus-dominus.init.js",
                        ...
                        dropzone: {
                            ...
                            scripts: [
                                ...
                                "{$config.path.common_src}/components/vendors/plugins/dropzone.init.js",
                            ],
                        },
                        quil: {
                        ...
                        chartjs: {
                            scripts: ["{$config.path.node_modules}/chart.components/dist/chart.js"],
                        },
                        countupjs: {
                            scripts: [
                                "{$config.path.node_modules}/countup.components/dist/countUp.umd.js",
                            ],
                        },
                        sweetalert2: {
                            styles: [
                            ...
                            scripts: [
                                ...
                                "{$config.path.common_src}/components/vendors/plugins/sweetalert2.init.js",
                            ],
                        },
                        keenicons: {
                            styles: [
            ...
            custom: {
                ...
                prismjs: {
                    src: {
                        ...
                        scripts: [
                            ...
                            "{$config.path.common_src}/components/vendors/plugins/prism.init.js",
                        ],
                    },
                    dist: {
                ...
                datatables: {
                    src: {
                        ...
                        scripts: [
                            "{$config.path.node_modules}/datatables.net/components/jquery.dataTables.js",
                            "{$config.path.node_modules}/datatables.net-bs5/components/dataTables.bootstrap5.js",
                            "{$config.path.common_src}/components/vendors/plugins/datatables.init.js",
                            ...
                            "{$config.path.node_modules}/datatables.net-buttons/components/dataTables.buttons.min.js",
                            "{$config.path.node_modules}/datatables.net-buttons-bs5/components/buttons.bootstrap5.min.js",
                            "{$config.path.node_modules}/datatables.net-buttons/components/buttons.colVis.js",
                            "{$config.path.node_modules}/datatables.net-buttons/components/buttons.flash.js",
                            "{$config.path.node_modules}/datatables.net-buttons/components/buttons.html5.js",
                            "{$config.path.node_modules}/datatables.net-buttons/components/buttons.print.js",
                            "{$config.path.node_modules}/datatables.net-colreorder/components/dataTables.colReorder.min.js",
                            "{$config.path.node_modules}/datatables.net-colreorder-bs5/components/colReorder.bootstrap5.js",
                            "{$config.path.node_modules}/datatables.net-fixedcolumns/components/dataTables.fixedColumns.min.js",
                            "{$config.path.node_modules}/datatables.net-fixedcolumns-bs5/components/fixedColumns.bootstrap5.js",
                            "{$config.path.node_modules}/datatables.net-fixedheader/components/dataTables.fixedHeader.min.js",
                            "{$config.path.node_modules}/datatables.net-fixedheader-bs5/components/fixedHeader.bootstrap5.js",
                            "{$config.path.node_modules}/datatables.net-responsive/components/dataTables.responsive.min.js",
                            "{$config.path.node_modules}/datatables.net-responsive-bs5/components/responsive.bootstrap5.min.js",
                            "{$config.path.node_modules}/datatables.net-rowgroup/components/dataTables.rowGroup.min.js",
                            "{$config.path.node_modules}/datatables.net-rowgroup-bs5/components/rowGroup.bootstrap5.js",
                            "{$config.path.node_modules}/datatables.net-rowreorder/components/dataTables.rowReorder.min.js",
                            "{$config.path.node_modules}/datatables.net-rowreorder-bs5/components/rowReorder.bootstrap5.js",
                            "{$config.path.node_modules}/datatables.net-scroller/components/dataTables.scroller.min.js",
                            "{$config.path.node_modules}/datatables.net-scroller-bs5/components/dataTables.bootstrap5.js",
                            "{$config.path.node_modules}/datatables.net-select/components/dataTables.select.min.js",
                            "{$config.path.node_modules}/datatables.net-select-bs5/components/dataTables.bootstrap5.js",
                ...
                typedjs: {
                    src: {
                        scripts: ["{$config.path.node_modules}/typed.components/lib/typed.js"],
                    },
                    dist: {
        ...
        widgets: {
            src: {
                scripts: [
                    "{$config.path.common_src}/components/widgets/**/*.js"
                ]
            },
            dist: {
                scripts: "{$config.dist}/components/widgets.bundle.js",
            }
        },
        custom: {
            src: {
                ...
                scripts: [
                    "{$config.path.common_src}/components/custom/**/*.js",
                    "{$config.path.src}/components/custom/**/*.js",
                ],
            },
            dist: {
                styles: "{$config.dist}/css/custom/",
                scripts: "{$config.dist}/components/custom/",
            },
        },
        media: {
            src: {
