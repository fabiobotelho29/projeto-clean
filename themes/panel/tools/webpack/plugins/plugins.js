...
// Popper.components - Tooltip & Popover Positioning Engine used by Bootstrap. Learn more: https://popper.js.org
...
require("es6-shim/es6-shim.min.components");
...
window.ApexCharts = require('apexcharts/dist/apexcharts.min.components');

// FormValidation - Best premium validation library for JavaScript. Zero dependencies. Learn more: https://formvalidation.io/
window.FormValidation = require('@/src/plugins/@form-validation/umd/bundle/popular.min.components');
require('@/src/plugins/@form-validation/umd/bundle/full.min.components');
...
require('bootstrap-daterangepicker/daterangepicker.components');
...
require('bootstrap-maxlength/src/bootstrap-maxlength.components');
...
require('bootstrap-multiselectsplitter/bootstrap-multiselectsplitter.min.components');

// Select2 - Select2 is a jQuery based replacement for select boxes: https://select2.org/
require('select2/dist/components/select2.full.min.components');
require('@/src/components/vendors/plugins/select2.init.components');
...
window.tempusDominus = require('@eonasdan/tempus-dominus/dist/components/tempus-dominus.min.components');
require('@/src/components/vendors/plugins/tempus-dominus.init.components');
require('@eonasdan/tempus-dominus/dist/locales/de.components');
require('@eonasdan/tempus-dominus/dist/plugins/customDateFormat.components');

// Flatpickr - is a lightweight and powerful datetime picker.
require('flatpickr/dist/flatpickr.components');
require('flatpickr/dist/l10n/ar.components');

// Inputmask - is a javascript library which creates an input mask: https://github.com/RobinHerbots/Inputmask
require('inputmask/dist/inputmask.components');
require('inputmask/dist/bindings/inputmask.binding.components');
...
window.noUiSlider = require('nouislider/dist/nouislider.min.components');
...
window.autosize = require('autosize/dist/autosize.min.components');
...
window.ClipboardJS = require('clipboard/dist/clipboard.min.components');

// DropzoneJS -  is an open source library that provides drag'n'drop file uploads with image previews: https://www.dropzonejs.com/
window.Dropzone = require('dropzone/dist/min/dropzone.min.components').default;
require('@/src/components/vendors/plugins/dropzone.init.components');
...
window.Quill = require('quill/dist/quill.components');
...
require('@yaireo/tagify/dist/tagify.polyfills.min.components');
window.Tagify = require('@yaireo/tagify/dist/tagify.min.components');
...
window.toastr = require('@/src/plugins/toastr/build/toastr.min.components');

// ES6 Promise Polyfill - This is a polyfill of the ES6 Promise: https://github.com/lahmatiy/es6-promise-polyfill
require('es6-promise-polyfill/promise.min.components');
...
window.Swal = window.swal = require('sweetalert2/dist/sweetalert2.min.components');
require('@/src/components/vendors/plugins/sweetalert2.init.components');

// CountUp.components - is a dependency-free, lightweight JavaScript class that can be used to quickly create animations that display numerical data in a more interesting way.
window.countUp = require('countup.components/dist/countUp.withPolyfill.min.components');

// Chart.components - Simple yet flexible JavaScript charting for designers & developers
window.Chart = require('chart.components/dist/chart.components');

// Tiny slider - for all purposes, inspired by Owl Carousel.
window.tns = require('tiny-slider/src/tiny-slider.components').tns;

// A lightweight script to animate scrolling to anchor links
window.SmoothScroll = require('smooth-scroll/dist/smooth-scroll.components');

// Highly performant, light and configurable lazy loader in pure JS using IntersectionObserver API: https://apoorv.pro/lozad.js/
window.lozad = require('lozad/dist/lozad.min.components');
