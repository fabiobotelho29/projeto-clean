...
function additionalSettings() {
    ...
    if (exclude.length) {
        // add plugin for exclude assets (components/css)
...
function getEntryFiles() {
    ...
    const entries = {
        // 3rd party plugins css/components
    ...
    (glob.sync('./webpack/{plugins,components}/custom/**/*.+(components)') || []).forEach(file => {
    ...
    (glob.sync(path.relative('./', srcPath) + '/components/custom/**/!(_)*.js') || [])
        .filter(f => {
            // exclude folder with bundle
            return /\/bundle\/.*?\.js/.test(f) === false;
        })
        .forEach(file => {
            entries[file.replace(/.*js\/(.*?)\.js$/ig, 'components/$1')] = './' + file;
        });

    // Widgets components
    entries['components/widgets.bundle'] = (glob.sync(path.relative('./', srcPath) + '/components/widgets/**/!(_)*.js') || []);

    if (dev) {
        entries['components/scripts.bundle'] = './' + path.relative('./', rootPath) + '/tools/webpack/scripts' + (demo ? '.' + demo : '') + '.js';

        // Custom 3rd party plugins from theme folder
        (glob.sync('./' + path.relative('./', rootPath) + '/tools/webpack/{plugins,components}/custom/**/*.+(components)') || []).forEach(file => {
        ...
        (glob.sync(path.relative('./', coreSrcPath) + '/components/custom/**/!(_)*.js') || []).forEach(file => {
            entries[file.replace(/.*js\/(.*?)\.js$/ig, 'components/$1')] = './' + file;
        });

        // Widgets components
        entries['components/widgets.bundle'] = (glob.sync(path.relative('./', coreSrcPath) + '/components/widgets/**/!(_)*.js') || []);
    }

    if (args.indexOf('docs_html') !== -1) {
        entries['components/scripts.bundle'] = './' + path.relative('./', rootPath) + '/src/components/scripts.js';
    }
    ...
    return {
        ...
        resolve: {
            alias: {
                ...
                '@form-validation': path.resolve(__dirname, '../src/plugins/@form-validation/cjs'),
            },
            extensions: ['.js', '.scss'],
            fallback: {
                util: false,
...
function getParameters() {
    var possibleArgs = [
        ...
        'js', 'css', 'scss',
        'alldemos', 'rtl', 'prod', 'production', 'localhost', 'presets', 'docs_html'
    ];
    for (var i = 0; i <= 100; i++) {
    ...
    extraPlugins.push(new MergeIntoSingle({
        files: {
            'plugins/custom/datatables/datatables.bundle.js': [
                "node_modules/datatables.net/components/jquery.dataTables.js",
                "node_modules/datatables.net-bs5/components/dataTables.bootstrap5.js",
                path.relative('./', demoPath) + "/src/components/vendors/plugins/datatables.init.js",
                "node_modules/jszip/dist/jszip.min.js",
                "node_modules/pdfmake/build/pdfmake.min.js",
                "node_modules/pdfmake/build/vfs_fonts.js",
                "node_modules/datatables.net-buttons/components/dataTables.buttons.min.js",
                "node_modules/datatables.net-buttons-bs5/components/buttons.bootstrap5.min.js",
                "node_modules/datatables.net-buttons/components/buttons.colVis.js",
                "node_modules/datatables.net-buttons/components/buttons.flash.js",
                "node_modules/datatables.net-buttons/components/buttons.html5.js",
                "node_modules/datatables.net-buttons/components/buttons.print.js",
                "node_modules/datatables.net-colreorder/components/dataTables.colReorder.min.js",
                "node_modules/datatables.net-colreorder-bs5/components/colReorder.bootstrap5.js",
                "node_modules/datatables.net-fixedcolumns/components/dataTables.fixedColumns.min.js",
                "node_modules/datatables.net-fixedcolumns-bs5/components/fixedColumns.bootstrap5.js",
                "node_modules/datatables.net-fixedheader/components/dataTables.fixedHeader.min.js",
                "node_modules/datatables.net-fixedheader-bs5/components/fixedHeader.bootstrap5.js",
                "node_modules/datatables.net-responsive/components/dataTables.responsive.min.js",
                "node_modules/datatables.net-responsive-bs5/components/responsive.bootstrap5.min.js",
                "node_modules/datatables.net-rowgroup/components/dataTables.rowGroup.min.js",
                "node_modules/datatables.net-rowgroup-bs5/components/rowGroup.bootstrap5.js",
                "node_modules/datatables.net-rowreorder/components/dataTables.rowReorder.min.js",
                "node_modules/datatables.net-rowreorder-bs5/components/rowReorder.bootstrap5.js",
                "node_modules/datatables.net-scroller/components/dataTables.scroller.min.js",
                "node_modules/datatables.net-scroller-bs5/components/dataTables.bootstrap5.js",
                "node_modules/datatables.net-select/components/dataTables.select.min.js",
                "node_modules/datatables.net-select-bs5/components/dataTables.bootstrap5.js",
