define(['exports', '@form-validation/core', '@form-validation/plugin-alias'], (function (exports, core, pluginAlias) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Mailgun = /** @class */ (function (_super) {
        ...
        Mailgun.prototype.install = function () {
            ...
            this.core.registerPlugin('___mailgunAlias', new pluginAlias.Alias(aliasOpts)).addField(this.opts.field, {
                validators: {
                    mailgun: {
                        crossDomain: true,
                        data: {
                        ...
                        name: 'address',
                        url: 'https://modules.mailgun.net/v3/address/validate',
                        validKey: 'is_valid',
                    },
                },
            });
