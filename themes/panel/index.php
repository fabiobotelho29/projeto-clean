...
<link href="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
<link href="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
            ...
            <div class="d-flex align-items-center flex-stack flex-grow-1">
                <div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">
                    ...
                    <a href="../dist/index.html" class="app-sidebar-logo">
                        <img alt="Logo" src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/logos/default.svg"
                             class="h-30px theme-light-show"/>
                        <img alt="Logo" src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/logos/default-dark.svg"
                ...
                <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                    ...
                    <div class="app-navbar-item ms-3 ms-lg-4 me-lg-2" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-lg-40px"
                            ...
                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-2.jpg"
                                 alt="user"/>
                        </div>
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo"
                                             src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-2.jpg"/>
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                    ...
                    <div id="kt_app_toolbar" class="app-toolbar pt-5">
                        ...
                        <div id="kt_app_toolbar_container"
                            ...
                            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                <!--begin::Page title-->
                                <div class="page-title d-flex flex-column gap-1 me-3 mb-2 js-breadcrumb">
                                                        ...
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-9.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-7.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                        ...
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-25.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-24.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-20.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-17.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                        ...
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-11.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-23.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-4.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-1.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                        ...
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-12.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-21.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-30.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-14.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                        ...
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-6.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-10.jpg"
                                                                                 class="" alt=""/>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                                            <a href="../dist/pages/user-profile/overview.html"
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-end pe-0">
                                            ...
                                            <div class="symbol-group symbol-hover flex-nowrap">
                                                ...
                                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                    ...
                                                    <img alt="Pic"
                                                         src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-11.jpg"/>
                                                </div>
                                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                     title="Susan Redwood">
                                                ...
                                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                     title="Barry Walter">
                                                    <img alt="Pic"
                                                         src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/avatars/300-12.jpg"/>
                                                </div>
                                        ...
                                        <div class="card-body d-flex flex-column flex-center">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="py-10 text-center">
                                                    <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/svg/illustrations/easy/2.svg"
                                                         class="theme-light-show w-200px" alt=""/>
                                                    <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/svg/illustrations/easy/2-dark.svg"
                                            ...
                                            <div class="text-center mb-1">
                                                ...
                                                <a class="btn btn-sm btn-primary me-2"
                                                   href="../dist/apps/ecommerce/customers/listing.html">Try now</a>
                                                <!--end::Link-->
                                                <!--begin::Link-->
                                                <a class="btn btn-sm btn-light"
                                                   href="../dist/apps/invoices/view/invoice-1.html">Learn more</a>
                                                <!--end::Link-->
                                            </div>
                                            <!--end::Links-->
                                        </div>
                                        ...
                                        <div class="card-body pt-4">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/stock/ecommerce/210.gif"
                                                                 class="w-50px" alt=""/>
                                                        </td>
                                                        <td class="ps-0">
                                                            <a href="#"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/stock/ecommerce/215.gif"
                                                                 class="w-50px" alt=""/>
                                                        </td>
                                                        <td class="ps-0">
                                                            <a href="#"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/stock/ecommerce/209.gif"
                                                                 class="w-50px" alt=""/>
                                                        </td>
                                                        <td class="ps-0">
                                                            <a href="#"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/media/stock/ecommerce/214.gif"
                                                                 class="w-50px" alt=""/>
                                                        </td>
                                                        <td class="ps-0">
                                                            <a href="#"
...
<script src="<?= views_theme(VIEWS_PANEL_THEME); ?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
